    ...
    return (
      <div className="RichEditor-controls">
        ...
        <Modal
          ...
          } > {this.props.lang.cancelText} < /Button>, <Button key="submit" type="primary" size="large" disabled={that.state.pfopImages.length==0}
            onClick={()=>that.realLoading("fromOld")}> {this.props.lang.validatedImage} </Button >]}>
